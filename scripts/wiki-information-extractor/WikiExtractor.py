...
# Output: Extracted text from .xml dump
# Sample run: ./WikiExtractor.py --processes 4 -o <output dir path> -b 2M -ns 'w' -it abbr,b,big --filter_disambig_pages --no-templates --discard_elements gallery,timeline,noinclude <input .xml file>
