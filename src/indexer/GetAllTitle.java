...
public class GetAllTitle {
    ...
    public GetAllTitle(String propPath) throws IOException {
    ...
    public void getAllTitle() throws IOException {

        System.out.print("Reading all document vectors in hashmap: ");
        ...
        for (int i = 0; i < hits_length; i++) {
            ...
            System.out.print(d.get(CommonVariables.FIELD_ID)+ "\t" +d.get(CommonVariables.FIELD_TITLE) + "\t");
...
//        /*
        ...
        getAllTitle = new GetAllTitle(args[0]);
